  ...
  const hostels: Hostel[] = [
    {
      ...
      name: "Bright Hostel",
      area: "Mirpur, Dhaka",
      address: { division: "Dhaka", district: "Dhaka", thana: "Mirpur" },
      ownerId: "u_owner",
      ...
      settings: {
        ...
        managerPermissions: { rooms: true, members: true, approvals: true, finance: true, billing: true, menu: true, duties: true, announcements: true, assignManager: true },
    ...
    },
    {
      ...
      address: { division: "Dhaka", district: "Dhaka", thana: "Dhanmondi" },
      ownerId: "u_owner",
