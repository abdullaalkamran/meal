...
/** The rooms management screen, shared by the manager page and the owner's
 * native rooms page — `memberHref` keeps member links inside whichever
 * section is rendering it. */
export function RoomsScreen({ memberHref }: { memberHref: (userId: string) => string }) {
